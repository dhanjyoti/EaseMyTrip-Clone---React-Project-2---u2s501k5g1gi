    ...
    <div className=" py-2 pl-2 my-3 border bg-white border-[#c9d7e1] rounded-2xl flex flex-row mr-[50px] transition-shadow duration-400 shadow-[0_0_10px_0_rgb(197_197_197_/_70%)] hover:shadow-[0_0_10px_0_rgb(33_150_243_/_70%)]">
      <div className="flex flex-row flex-1">
        <div>
          <img
            onClick={onClick}
            className="rounded-xl w-[293px] h-[202px] cursor-pointer"
            src={hotelImage}
          />
        </div>
        {/* Second Part */}
        <div className="flex flex-col gap-1 shrink-0 pl-5">
      ...
      {/* Third part */}
      <div className="pr-5 max-w-[190px] min-w-[190px] w-[190px] flex flex-col items-end justify-between border-l border-[#ebebeb]">
        ...
        <div
          onClick={onClick}
          className="cursor-pointer text-white bg-[#ef6614] py-[7px] ml-4 w-[150px] self-baseline text-center text-sm rounded-[40px]"
        >
          View Room
        </div>
      </div>
