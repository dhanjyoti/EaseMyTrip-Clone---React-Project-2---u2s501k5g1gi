...
const OfferCard = ({
  ...
  return (
    <div className="w-[330px] flex flex-col gap-5 shadow-[0_0_7px_rgb(0_-1_6_/_6%)_inset] border border-[#F5F5F5] p-[10px] rounded">
      <div
        className={
          "flex flex-row justify-between px-4 pt-[10px] text-white rounded-xl min-h-[170px]" +
          " " +
          className
        }
      >
        <div className="flex flex-col">
          ...
          <div
            style={{ background: offerBg }}
            className=" mb-2 border border-dashed border-white rounded w-fit px-2 py-0.5"
          >
            <div>
