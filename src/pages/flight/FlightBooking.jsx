        ...
        <div className="flex flex-col gap-6 flex-1">
            ...
            <div className="flex flex-row gap-2 px-3 py-3">
              ...
              <div>
                <p className="flex flex-row gap-1">
                  <h3 className="text-[#2196f3] text-[15px] font-semibold">FREE Medical Refund Policy</h3>
                  <img src={RightTeak}/>
                </p>
                <p>Get full airline refund, if you cancel tickets due to illness or sickness. This  service is provided at sickness. This service is provided at <b>ZERO additional charges</b>.</p>
              </div>
            </div>
            <div className="pl-6 bg-[#f7f7f7] py-3">
              <p className="flex flex-row gap-2 pb-[6px]">
                <input className="w-[18px]" type="radio" name="select"/>
                <p>Yes, I want to add Medical Refund Policy (FREE) to this flight</p>
              </p>
              <p className="flex flex-row gap-2">
                <input className="w-[18px]" type="radio" name="select"/>
                <p>No, I don't wish to add Medical Refund Policy (FREE) to this flight</p>
              </p>
            </div>
          </div>
          ...
          <div className="shadow-sm shadow-[#b8d0e5] rounded text-xs">
              ...
              <ul className="list-disc mx-9 py-2">
                <li>15 Kgs per passenger Check-in Baggage included for your selected flight on the sector  Delhi to Mumbai</li>
                <li>Airline Cancellation Fee is Rs 3180 per passenger for your selected flight on the sector Delhi to Mumbai</li>
          ...
          <div className="shadow-sm shadow-[#b8d0e5] rounded bg-[#e3f8fa] text-xs py-[10px] px-6">
            ...
            <ul className="list-disc px-3">
              <li className="pt-2">Wearing face masks is no longer compulsory. However, it’s highly advised to wear masks to stay protected from threats imposed by COVID-19.</li>
              <li className="pt-1">Travellers can check the detailed travel guidelines issued by the Indian government. <span className="text-[#337ab7]">Click here...</span> to know more.</li>
            </ul>
          </div>
          <div>hello</div>
          <div>hello</div>
